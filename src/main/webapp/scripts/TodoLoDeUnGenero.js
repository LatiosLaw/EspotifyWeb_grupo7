...
var Genero = "0";
            ...
            fetch('http://192.168.1.146:8080/EspotifyWeb/TodoLoDeUnGeneroServlet?action=MostrarListasDelGeneroU&buscar=' + encodeURIComponent(buscarName))
    ...
    fetch('http://192.168.1.146:8080/EspotifyWeb/TodoLoDeUnGeneroServlet?action=MostrarAlbumesDelGeneroU&buscar=' + encodeURIComponent(buscarName))
        .then(response => response.json())
        .then(data => {
